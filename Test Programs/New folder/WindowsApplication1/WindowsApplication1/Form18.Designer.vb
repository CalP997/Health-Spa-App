...
Partial Class Form18
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "From this page you can view all member details that are stored on the system. Thi" & _
    "s can be done by clicking the view details button on screen. "
