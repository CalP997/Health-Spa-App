...
Partial Class Form15
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "From this page you can create a new membership by entering a members details into" & _
    " the boxes on screen. Once complete, the button can then be clicked to save thes" & _
    "e details to the file."
