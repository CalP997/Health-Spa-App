...
Partial Class Form20
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "From this page you can view the discounts that Bronze members recieve to activity" & _
    " prices. This can be done by clicking the apply discount button."
